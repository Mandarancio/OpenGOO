...
OGWorld::OGWorld(EntityFactory& a_factory, const QString& a_levelname, const QString& a_language, QObject* a_parent)
    : QObject(a_parent)
    , m_entityFactory(a_factory)
    , levelName_(a_levelname)
    , language_(a_language)
    , m_physicsEngine(PhysicsEngineFactory::Create())
{
